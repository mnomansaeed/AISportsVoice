...
namespace AISportsApp.Pages
{
    ...
    public class subcategoryModel : PageModel
    {
        ...
        public subcategoryModel(IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IActionResult> OnPostDeleteAsync()
        {
            ...
            try
            {
                ...
                using (StreamReader reader = new StreamReader(stream))
                {
                    ...
                    {
                        var obj = JsonConvert.DeserializeObject<ObjSubCategoryData>(requestBody);
                        if (obj != null)
                        {
                            var id = obj.Id;
...
""lstSubCategory"": null
                            ...
                            var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/SubCategory/DeleteSubCategory", content);
                            ...
                            else
                            {
                                ...
                                return new JsonResult(new { success = false, message = GlobalConstants.ValidIssuer + "/api/SubCategory/DeleteSubCategory" + " " + HTMLHelper.GetErrorMessage(responseString) });
                            }
                        }
                    }
                }
    ...
    public class ObjSubCategoryData
    {
