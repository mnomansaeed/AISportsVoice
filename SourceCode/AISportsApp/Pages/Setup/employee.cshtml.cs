...
namespace AISportsApp.Pages
{
    ...
    public class employeeModel : PageModel
    {
        ...
        public employeeModel(IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IActionResult> OnPostDeleteAsync()
        {
            ...
            try
            {
                ...
                using (StreamReader reader = new StreamReader(stream))
                {
                    ...
                    {
                        var obj = JsonConvert.DeserializeObject<ObjEmployeeData>(requestBody);
                        if (obj != null)
                        {
                            var id = obj.Id;
...
""lstEmployee"": null
                            ...
                            var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/Employee/DeleteEmployee", content);
                            ...
                            else
                            {
                                ...
                                return new JsonResult(new { success = false, message = GlobalConstants.ValidIssuer + "/api/Employee/DeleteEmployee" + " " + HTMLHelper.GetErrorMessage(responseString) });
                            }
                        }
                    }
                }
