...
namespace AISportsApp.Pages
{
    ...
    public class add_userModel : PageModel
    {
        ...
        public add_userModel(IHttpContextAccessor httpContextAccessor)
        {
...
""lstUser"": null
                ...
                var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/User/AddUser", content);
                ...
                else
                {
                    ...
                    ModelState.AddModelError(string.Empty, GlobalConstants.ValidIssuer + "/api/User/AddUser" + " " + HTMLHelper.GetErrorMessage(responseString));
                    return Page();
                }
            }
            catch (Exception ex)
