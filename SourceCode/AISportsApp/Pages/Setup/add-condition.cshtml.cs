...
{
[Authorize]
public class add_conditionModel :  PageModel
{
...
public add_conditionModel(IHttpContextAccessor httpContextAccessor)
{
...
var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/Condition/AddCondition",content);
...
ModelState.AddModelError(string.Empty,GlobalConstants.ValidIssuer + "/api/Condition/AddCondition" + " " + HTMLHelper.GetErrorMessage(responseString));
return Page();
}
}
catch (Exception ex)
