...
{
    [Authorize]
    public class add_vendorModel : PageModel
    {
        ...
        public add_vendorModel(IHttpContextAccessor httpContextAccessor)
        {
        ...
        [BindProperty]
        [StringLength(50, ErrorMessage = "VAT Number cannot be longer than 50 characters")]
...
""lstVendor"": null
                ...
                var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/Vendor/AddVendor", content);
                ...
                else
                {
                    ...
                    ModelState.AddModelError(string.Empty, GlobalConstants.ValidIssuer + "/api/Vendor/AddVendor" + " " + HTMLHelper.GetErrorMessage(responseString));
                    return Page();
                }
            }
            catch (Exception ex)
