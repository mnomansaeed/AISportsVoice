...
{
    [Authorize]
    public class add_cycletypeModel : PageModel
    {
        ...
        public add_cycletypeModel(IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IActionResult> OnPostAddCycleTypeAsync()
        {
            // Validate the model
...
""lstCycleType"": null
                ...
                var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/CycleType/AddCycleType", content);
                ...
                else
                {
                    ...
                    ModelState.AddModelError(string.Empty, GlobalConstants.ValidIssuer + "/api/CycleType/AddCycleType" + " " + HTMLHelper.GetErrorMessage(responseString));
                    return Page();
                }
            }
            catch (Exception ex)
