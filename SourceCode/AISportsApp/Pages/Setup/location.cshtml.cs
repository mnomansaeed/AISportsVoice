...
public locationModel(IHttpContextAccessor httpContextAccessor)
{
...
{
var obj = JsonConvert.DeserializeObject<ObjLocationData>(requestBody);
if (obj != null)
{
var id = obj.Id;
...
var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/Location/DeleteLocation",content);
...
var responseString = await response.Content.ReadAsStringAsync();
 return new JsonResult(new { success = false, message = GlobalConstants.ValidIssuer + "/api/Location/DeleteLocation" + " " + HTMLHelper.GetErrorMessage(responseString) });
}
}
}
}
