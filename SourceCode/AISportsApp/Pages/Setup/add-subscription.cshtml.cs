...
FormName: add-subscription.cshtml
/*****************************************************************************************************************/
...
namespace AISportsApp.Pages
{
    ...
    public class add_subscriptionModel : PageModel
    {
        ...
        public add_subscriptionModel(IHttpContextAccessor httpContextAccessor)
        {
...
""lstSubscription"": null
                ...
                var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/Subscription/AddSubscription", content);
                ...
                else
                {
                    ...
                    ModelState.AddModelError(string.Empty, GlobalConstants.ValidIssuer + "/api/Subscription/AddSubscription" + " " + HTMLHelper.GetErrorMessage(responseString));
                    return Page();
                }
            }
            catch (Exception ex)
