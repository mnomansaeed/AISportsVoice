...
namespace AISportsApp.Pages
{
    ...
    public class subscriptionModel : PageModel
    {
        ...
        public subscriptionModel(IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IActionResult> OnPostDeleteAsync()
        {
            ...
            try
            {
                ...
                using (StreamReader reader = new StreamReader(stream))
                {
                    ...
                    {
                        var obj = JsonConvert.DeserializeObject<ObjSubscriptionData>(requestBody);
                        if (obj != null)
                        {
                            var id = obj.Id;
...
""lstSubscription"": null
                            ...
                            var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/Subscription/DeleteSubscription", content);
                            ...
                            else
                            {
                                ...
                                return new JsonResult(new { success = false, message = GlobalConstants.ValidIssuer + "/api/Subscription/DeleteSubscription" + " " + HTMLHelper.GetErrorMessage(responseString) });
                            }
                        }
                    }
                }
    ...
    public class ObjSubscriptionData
    {
