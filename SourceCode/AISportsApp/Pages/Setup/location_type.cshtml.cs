...
{
    [Authorize]
    public class location_typeModel : PageModel
    {
        private readonly HttpClient _httpClient;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public location_typeModel(IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IActionResult> OnPostDeleteAsync()
        {
            ...
            try
            {
                ...
                using (StreamReader reader = new StreamReader(stream))
                {
                    ...
                    {
                        var obj = JsonConvert.DeserializeObject<ObjLocation_TypeData>(requestBody);
                        if (obj != null)
                        {
                            var id = obj.Id;
...
""lstLocation_Type"": null
                            ...
                            var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/Location_Type/DeleteLocation_Type", content);
                            ...
                            else
                            {
                                ...
                                return new JsonResult(new { success = false, message = GlobalConstants.ValidIssuer + "/api/Location_Type/DeleteLocation_Type" + " " + HTMLHelper.GetErrorMessage(responseString) });
                            }
                        }
                    }
                }
    ...
    public class ObjLocation_TypeData
    {
