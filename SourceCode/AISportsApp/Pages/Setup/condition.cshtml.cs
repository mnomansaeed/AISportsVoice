...
namespace AISportsApp.Pages
{
    ...
    public class conditionModel : PageModel
    {
        ...
        public conditionModel(IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IActionResult> OnPostDeleteAsync()
        {
            ...
            try
            {
                ...
                using (StreamReader reader = new StreamReader(stream))
                {
                    ...
                    {
                        var obj = JsonConvert.DeserializeObject<ObjConditionData>(requestBody);
                        if (obj != null)
                        {
                            var id = obj.Id;
...
""lstCondition"": null
                            ...
                            var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/Condition/DeleteCondition", content);
                            ...
                            else
                            {
                                ...
                                return new JsonResult(new { success = false, message = GlobalConstants.ValidIssuer + "/api/Condition/DeleteCondition" + " " + HTMLHelper.GetErrorMessage(responseString) });
                            }
                        }
                    }
                }
