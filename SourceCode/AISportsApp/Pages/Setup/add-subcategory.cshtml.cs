...
FormName: add-subcategory.cshtml
/*****************************************************************************************************************/
...
{
[Authorize]
public class add_subcategoryModel :  PageModel
{
...
public add_subcategoryModel(IHttpContextAccessor httpContextAccessor)
{
...
var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/SubCategory/AddSubCategory",content);
...
ModelState.AddModelError(string.Empty,GlobalConstants.ValidIssuer + "/api/SubCategory/AddSubCategory" + " " + HTMLHelper.GetErrorMessage(responseString));
return Page();
}
}
catch (Exception ex)
