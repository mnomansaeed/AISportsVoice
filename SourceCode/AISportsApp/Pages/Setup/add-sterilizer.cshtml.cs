...
FormName: add-sterilizer.cshtml
/*****************************************************************************************************************/
...
{
    [Authorize]
    public class add_sterilizerModel : PageModel
    {
        ...
        public add_sterilizerModel(IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IActionResult> OnPostAddSterilizerAsync()
        {
            // Validate the model
...
""lstSterilizer"": null
                ...
                var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/Sterilizer/AddSterilizer", content);
                ...
                else
                {
                    ...
                    ModelState.AddModelError(string.Empty, GlobalConstants.ValidIssuer + "/api/Sterilizer/AddSterilizer" + " " + HTMLHelper.GetErrorMessage(responseString));
                    return Page();
                }
            }
            catch (Exception ex)
