        ...
        public async Task<IActionResult> OnPostDeleteAsync()
        {
            ...
            try
            {
                ...
                using (StreamReader reader = new StreamReader(stream))
                {
                    ...
                    {
                        var obj = JsonConvert.DeserializeObject<ObjUserData>(requestBody);
                        if (obj != null)
                        {
                            var id = obj.Id;
...
""lstUser"": null
                            ...
                            var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/User/DeleteUser", content);
                            ...
                            else
                            {
                                ...
                                return new JsonResult(new { success = false, message = GlobalConstants.ValidIssuer + "/api/User/DeleteUser" + " " + HTMLHelper.GetErrorMessage(responseString) });
                            }
                        }
                    }
                }
