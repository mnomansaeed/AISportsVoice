...
FormName: add-sterilizertype.cshtml
/*****************************************************************************************************************/
...
{
[Authorize]
public class add_sterilizertypeModel :  PageModel
{
...
public add_sterilizertypeModel(IHttpContextAccessor httpContextAccessor)
{
...
public async Task<IActionResult> OnPostAddSterilizerTypeAsync()
{
 // Validate the model
...
var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/SterilizerType/AddSterilizerType",content);
...
ModelState.AddModelError(string.Empty,GlobalConstants.ValidIssuer + "/api/SterilizerType/AddSterilizerType" + " " + HTMLHelper.GetErrorMessage(responseString));
return Page();
}
}
catch (Exception ex)
