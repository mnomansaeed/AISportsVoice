...
namespace AISportsApp.Pages
{
    ...
    public class add_categoryModel : PageModel
    {
        ...
        public add_categoryModel(IHttpContextAccessor httpContextAccessor)
        {
...
""lstCategory"": null
                ...
                var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/Category/AddCategory", content);
                ...
                else
                {
                    ...
                    ModelState.AddModelError(string.Empty, GlobalConstants.ValidIssuer + "/api/Category/AddCategory" + " " + HTMLHelper.GetErrorMessage(responseString));
                    return Page();
                }
            }
            catch (Exception ex)
