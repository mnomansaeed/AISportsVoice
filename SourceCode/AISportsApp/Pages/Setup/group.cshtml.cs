...
namespace AISportsApp.Pages
{
    ...
    public class groupModel : PageModel
    {
        ...
        public groupModel(IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IActionResult> OnPostDeleteAsync()
        {
            ...
            try
            {
                ...
                using (StreamReader reader = new StreamReader(stream))
                {
                    ...
                    {
                        var obj = JsonConvert.DeserializeObject<ObjGroupData>(requestBody);
                        if (obj != null)
                        {
                            var id = obj.Id;
...
""lstGroup"": null
                            ...
                            var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/Group/DeleteGroup", content);
                            ...
                            else
                            {
                                ...
                                return new JsonResult(new { success = false, message = GlobalConstants.ValidIssuer + "/api/Group/DeleteGroup" + " " + HTMLHelper.GetErrorMessage(responseString) });
                            }
                        }
                    }
                }
