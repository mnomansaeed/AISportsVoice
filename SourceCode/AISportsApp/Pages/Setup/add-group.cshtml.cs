...
{
    [Authorize]
    public class add_groupModel : PageModel
    {
        ...
        public add_groupModel(IHttpContextAccessor httpContextAccessor)
        {
...
""lstGroup"": null
                ...
                var response = await _httpClient.PostAsync(GlobalConstants.ValidIssuer + "/api/Group/AddGroup", content);
                ...
                else
                {
                    ...
                    ModelState.AddModelError(string.Empty, GlobalConstants.ValidIssuer + "/api/Group/AddGroup" + " " + HTMLHelper.GetErrorMessage(responseString));
                    return Page();
                }
            }
            catch (Exception ex)
